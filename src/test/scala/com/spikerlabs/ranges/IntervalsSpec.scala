...
class IntervalsSpec extends FlatSpec with Matchers {
  "sample ranges" should "count dummy range" in {
    val ranges = SampleRanges(List((1.0, 2.0), (1.0, 4.0), (7.0, 9.0), (1.0, 10.0), (3.0, 5.0)))
  ...
  it should "count sample range" in {
    val ranges = SampleRanges(List((0.0, 12.0), (106.0, 122.0), (123.0, 124.0), (11.0, 33.0), (33.0, 34.0)))
  ...
  "optimised ranges" should "count at point matching exactly with start" in {
